...
- Firestore 대신 HashTable로 구현한 FakeFirestore(모든 Operation의 Time Complexity는 O(1)이 보장됩니다.)를 Debug/Unit Test에 이용하여 Firestore에 대한 Side Effect와 Unit Test 시간을 줄였습니다.
