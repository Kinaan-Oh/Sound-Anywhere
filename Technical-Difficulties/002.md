...
"Asking a question should not change the answer."에 기초하여 의도치 않은 버그 회피에 유용. 또한 Unit Test에
Stub, Mock을 명확히 구분하여 적용할 수 있다는 이점이 있음.
...
자료구조로 구현한 FakeFirestore를 구현/적용하면 동일한 Operation에 대해 Time Complexity O(1)을 보장, Side Effect 회피.
